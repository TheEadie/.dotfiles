...
Render the plan body to `/tmp/sticky-plan.md` with `<!-- claude:sticky:plan -->` as the first line, then create or update the `plan` sticky comment using the write flow above.
